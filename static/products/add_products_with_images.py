...
Scans static/products/ and creates ONLY the products that have an image.
Run: python add_products_with_images.py
"""
...
# Master catalog: filename → (name, category, price, description, stock)
CATALOG = {
    ...
    "letusc-book.jpg":      ("Let Us C — Yashavant Kanetkar (13th Ed.)", "Books", 350, "Perfect for beginners. Slight cover wear. No tears.", 2),
    "python-book.jpg":      ("Python Crash Course — 3rd Edition", "Books", 600, "Like new. Opened only a few times. Great for self-study.", 1),
    "networks-book.jpg":    ("Computer Networks — Tanenbaum (5th Ed.)", "Books", 550, "5th semester textbook. Highlighted important sections.", 1),
    "casio-calc.jpg":       ("Casio FX-991ES Plus Scientific Calculator", "Electronics", 1800, "Barely used. Comes with original cover. Perfect for exams.", 2),
    ...
    "hp-charger.jpg":       ("HP Original 65W Laptop Charger", "Electronics", 1500, "Genuine HP charger. Works with most Pavilion and ProBook models.", 3),
    ...
    "handwritten-notes.jpg":("BSc CSIT 3rd Semester — Complete Handwritten Notes", "Notes", 150, "All subjects covered. Clear handwriting. PDF emailed after payment.", 99),
    ...
    "lab-manual.jpg":       ("Data Structures Lab Manual — Complete Programs", "Notes", 200, "All lab programs with sample outputs. C and C++ implementations.", 99),
    ...
    "pencils.jpg":          ("Apsara Pencils + Eraser + Sharpener Combo", "Stationery", 90, "New pack. 10 pencils included. Ideal for exam prep.", 8),
    "study-table.jpg":      ("Wooden Study Table with Drawer", "Furniture", 3500, "Sturdy wooden table, 3x2 feet. Minor scratches.", 1),
    "table-lamp.jpg":       ("Study Table LED Lamp — Adjustable", "Furniture", 650, "3 brightness levels. USB powered. Great for late-night study.", 4),
    "study-chair.jpg":      ("Plastic Study Chair — Sturdy", "Furniture", 800, "Comfortable plastic chair. No cracks. Pairs with a study table.", 2),
    "hoodie.jpg":           ("College Hoodie — Size M (Navy)", "Clothing", 1100, "Washed once, worn twice. Too small for me. Like-new condition.", 1),
    "tshirt.jpg":           ("Casual T-Shirt — Size L (Grey)", "Clothing", 500, "New with tags. Bought wrong size. 100% cotton.", 2),
    "jacket.jpg":           ("Winter Jacket — Size M (Black)", "Clothing", 2200, "Warm fleece-lined. Used one winter. Excellent condition.", 1),
...
def main():
    ...
    # Match only files we have metadata for
    to_add = []
    ...
    seller = cur.fetchone()
    if not seller:
        print("ERROR: No seller found in users table. Run your app once to create one.")
        sys.exit(1)
    ...
    for name, cat, price, desc, stock, filename in to_add:
        ...
        cur.execute(
            """INSERT INTO products
               (name, category, price, icon, description, stock, seller_id, image_url)
               VALUES (?,?,?,?,?,?,?,?)""",
